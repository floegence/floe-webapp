...
export default defineConfig(({ command }) => {
  ...
  const workspaceAliases = useWorkspaceSources
    ? [
        ...
        {
          find: '@floegence/floe-webapp-core/full',
          replacement: resolve(repoRoot, 'packages/core/src/full.ts'),
        },
        {
          find: '@floegence/floe-webapp-core/app',
          replacement: resolve(repoRoot, 'packages/core/src/app.ts'),
        },
        {
          find: '@floegence/floe-webapp-core/layout',
          replacement: resolve(repoRoot, 'packages/core/src/layout.ts'),
        },
        {
          find: '@floegence/floe-webapp-core/deck',
          replacement: resolve(repoRoot, 'packages/core/src/deck.ts'),
        },
        {
          find: '@floegence/floe-webapp-core/ui',
          replacement: resolve(repoRoot, 'packages/core/src/ui.ts'),
        },
        {
          find: '@floegence/floe-webapp-core/icons',
          replacement: resolve(repoRoot, 'packages/core/src/icons.ts'),
        },
        {
          find: '@floegence/floe-webapp-core/loading',
          replacement: resolve(repoRoot, 'packages/core/src/loading.ts'),
        },
        {
          find: '@floegence/floe-webapp-core/launchpad',
          replacement: resolve(repoRoot, 'packages/core/src/launchpad.ts'),
        },
        {
          find: '@floegence/floe-webapp-core/file-browser',
          replacement: resolve(repoRoot, 'packages/core/src/file-browser.ts'),
        },
        {
          find: '@floegence/floe-webapp-core/chat',
        ...
        {
          find: '@floegence/floe-webapp-core/widgets',
          replacement: resolve(repoRoot, 'packages/core/src/widgets.ts'),
        },
        {
          find: '@floegence/floe-webapp-core/terminal',
        ...
        {
          find: '@floegence/floe-webapp-protocol',
