...
This document is aligned with `@floegence/flowersec-core@0.20.2`. Consumers must depend on `^0.20.2` or a later compatible release before adopting the artifact-first reconnect contracts described below.
