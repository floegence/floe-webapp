...
Runtime bootstrap is owned by `@floegence/floe-webapp-boot` and targets `@floegence/flowersec-core@2.0.0`. It creates an `ArtifactSource` and passes it to the browser `createConnectionController` API.
