...
Artifact requests use HTTPS by default and reject redirects. Local development may opt into literal loopback HTTP explicitly; the option does not permit HTTP for network hosts:
