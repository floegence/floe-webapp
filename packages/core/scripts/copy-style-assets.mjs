...
const copies = [
  ...['progress-shimmer', 'window-status'].map((name) => ({ src: resolve(pkgRoot, `src/styles/${name}.css`), dest: resolve(pkgRoot, `dist/${name}.css`) })),
  ...
  {
    src: resolve(pkgRoot, 'src/components/layout/displayMode.css'),
    dest: resolve(pkgRoot, 'dist/display-mode.css'),
  },
  {
