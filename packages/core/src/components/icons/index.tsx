...
// MonitorPointer icon (computer surface with an active pointer)
export const MonitorPointer = (props: IconProps = {}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={props.size ?? 24}
    height={props.size ?? 24}
  ...
  >
    ...
    <path d="M21 11V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6" />
    <path d="M8 21h3" />
    <path d="M10 17v4" />
  </svg>
);
...
export const Refresh = (props: IconProps = {}) => (
  <svg
    ...
    class={props.class}
  >
    <path d={refreshIconPaths[0]} />
    <path d={refreshIconPaths[1]} />
    <path d={refreshIconPaths[2]} />
    <path d={refreshIconPaths[3]} />
  </svg>
);
