...
export function NotesAnimalIcon(props: { iconKey: TopicIconKey; class?: string }): JSX.Element {
  return (
    <Switch fallback={<NotesFoxIcon class={props.class} />}>
      <Match when={props.iconKey === 'crane'}>
        <NotesCraneIcon class={props.class} />
      </Match>
      <Match when={props.iconKey === 'otter'}>
        <NotesOtterIcon class={props.class} />
      </Match>
      <Match when={props.iconKey === 'lynx'}>
        <NotesLynxIcon class={props.class} />
      </Match>
      <Match when={props.iconKey === 'whale'}>
        <NotesWhaleIcon class={props.class} />
      </Match>
      <Match when={props.iconKey === 'hare'}>
        <NotesHareIcon class={props.class} />
      </Match>
    </Switch>
  );
}
