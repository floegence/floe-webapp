...
export const CLASSIC_LIGHT_CSS_TOKENS = {
  ...
  '--muted': '#e9ece3', '--muted-foreground': '#626e60',
  ...
  '--activity-bar': '#eeede6', '--activity-bar-foreground': '#626e60',
...
export const CLASSIC_DARK_CSS_TOKENS = {
  ...
  '--muted': '#343738', '--muted-foreground': '#9ba29e',
  ...
  '--activity-bar': '#17191a', '--activity-bar-foreground': '#9ba29e',
