...
export function createShellThemePreset(definition: ShellThemePaletteDefinition): FloeThemePreset {
  ...
  const tokenMap: Record<ShellThemeTokenName, string> & FloeThemeTokenMap = {
    ...
    '--accent': definition.accent ?? definition.muted,
    '--accent-foreground': definition.foreground,
    '--border': definition.border,
    '--input': definition.input,
    '--ring': definition.ring ?? definition.primary,
    ...
    '--sidebar-accent': definition.accent ?? definition.muted,
    '--sidebar-accent-foreground': definition.foreground,
    '--sidebar-border': definition.border,
    '--sidebar-ring': definition.ring ?? definition.primary,
...
const classicLightPreset = {
  ...createShellThemePreset({
    ...
    mode: 'light',
    background: CLASSIC_LIGHT_SEMANTIC_TOKENS['--background']!,
    foreground: CLASSIC_LIGHT_SEMANTIC_TOKENS['--foreground']!,
    card: CLASSIC_LIGHT_SEMANTIC_TOKENS['--card']!,
    muted: CLASSIC_LIGHT_SEMANTIC_TOKENS['--muted']!,
    mutedForeground: CLASSIC_LIGHT_SEMANTIC_TOKENS['--muted-foreground']!,
    primary: CLASSIC_LIGHT_SEMANTIC_TOKENS['--primary']!,
    primaryForeground: CLASSIC_LIGHT_SEMANTIC_TOKENS['--primary-foreground']!,
    border: CLASSIC_LIGHT_SEMANTIC_TOKENS['--border']!,
    input: CLASSIC_LIGHT_SEMANTIC_TOKENS['--input']!,
    sidebar: CLASSIC_LIGHT_SEMANTIC_TOKENS['--sidebar']!,
...
const classicDarkPreset = {
  ...createShellThemePreset({
    ...
    mode: 'dark',
    background: CLASSIC_DARK_SEMANTIC_TOKENS['--background']!,
    foreground: CLASSIC_DARK_SEMANTIC_TOKENS['--foreground']!,
    card: CLASSIC_DARK_SEMANTIC_TOKENS['--card']!,
    muted: CLASSIC_DARK_SEMANTIC_TOKENS['--muted']!,
    mutedForeground: CLASSIC_DARK_SEMANTIC_TOKENS['--muted-foreground']!,
    primary: CLASSIC_DARK_SEMANTIC_TOKENS['--primary']!,
    primaryForeground: CLASSIC_DARK_SEMANTIC_TOKENS['--primary-foreground']!,
    border: CLASSIC_DARK_SEMANTIC_TOKENS['--border']!,
    input: CLASSIC_DARK_SEMANTIC_TOKENS['--input']!,
    sidebar: CLASSIC_DARK_SEMANTIC_TOKENS['--sidebar']!,
...
export const builtInShellThemePresets = [
  ...
  createShellThemePreset({
    ...
    description: 'Warm white text and neutral controls on a near-black canvas with quiet charcoal surfaces.',
    mode: 'dark',
    background: '#0C0C0D',
    foreground: '#F2F1EE',
    card: '#1A1A1B',
    muted: '#252526',
    mutedForeground: '#B7B6B3',
    primary: '#E8E7E3',
    ...
    terminalForeground: '#F2F1EE',
    selectionBackground: '#454544',
    selectionForeground: '#FFFFFF',
    chart: ['#E8E7E3', '#79B8FF', '#C19BE8', '#72D39C', '#F0C36A'],
    syntax: {
      comment: '#B7B6B3',
      keyword: '#C19BE8',
      string: '#9AD49D',
