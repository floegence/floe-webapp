...
const server = createServer(async (request, response) => {
  if (request.url === '/app.js') {
    ...
    response.end(`globalThis.document.querySelector('#root').innerHTML = '<header>Product shell</header><main data-floe-reload-scroll="content"><article><h1>Private workspace</h1><p>/private/path?token=secret</p><input value="secret" /><img src="/private-icon" /></article><div style="height:1600px"></div></main>';
      globalThis.window.__floeReloadPlaceholder.finish(); globalThis.window.__floeReloadPlaceholder.arm(globalThis.document.body, 'header,main,article');`);
    return;
  }
